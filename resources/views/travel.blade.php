            ...
            <div class="row">
                ...
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h5 class="m-0 font-weight-bold text-primary">Travel Data Table</h5><br>
                    </div><br>
                    <div class="text-left" style="padding-left: 20px">
                        <a href="{{ route('admin.tabel_data_travel.create') }}" class="btn btn-success">Tambah Data</a>
                    </div><br>                    
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img style="width: 100px;height: 100px;object-fit: cover;border-radius: 20%;"
                                            src="{{ asset('storage/' . $travel->image) }}"
                                            alt="gambar"></td>
                                    <td>{{ $travel->description }}</td>
                                    <td>
                                        <div style="display: flex; gap: 10px;">
                                            <a href="{{ route('admin.tabel_data_travel.edit', $travel->id) }}" class="btn btn-primary">Edit</a>
                                            <form action="{{ route('admin.tabel_data_travel.destroy', $travel->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
