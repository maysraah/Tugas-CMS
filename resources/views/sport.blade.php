            ...
            <div class="row">
                ...
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h5 class="m-0 font-weight-bold text-primary">Sport Data Table</h5><br>
                    </div><br>
                    <div class="text-left" style="padding-left: 20px">
                        <a href="{{ route('admin.tabel_data_sport.create') }}" class="btn btn-success">Tambah Data</a>
                    </div><br>                    
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img style="width: 100px;height: 100px;object-fit: cover;border-radius: 20%;"
                                            src="{{ asset('storage/' . $sport->image) }}"
                                            alt="gambar"></td>
                                    <td>{{ $sport->description }}</td>
                                    <td>
                                        <div style="display: flex; gap: 10px;">
                                            <a href="{{ route('admin.tabel_data_sport.edit', $sport->id) }}" class="btn btn-primary">Edit</a>
                                            <form action="{{ route('admin.tabel_data_sport.destroy', $sport->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
